DROP DATABASE IF EXISTS d_october_2016;
CREATE DATABASE d_october_2016;
USE d_october_2016;
...
CREATE TABLE deposit_types(
	deposit_type_id INT(11) PRIMARY KEY AUTO_INCREMENT,
	name VARCHAR(20));
...
CREATE TABLE deposits(
	deposit_id INT(11) PRIMARY KEY AUTO_INCREMENT,
	 ...
	 customer_id INT(11),
	 CONSTRAINT fk_deposit_types_deposit_type_id FOREIGN KEY (deposit_type_id) REFERENCES deposit_types(deposit_type_id),
...
CREATE TABLE credit_history(
	credit_history_id INT(11) PRIMARY KEY AUTO_INCREMENT,
	mark CHAR(1),
	start_date DATE,
	end_date DATE,
	customer_id INT(11),
	CONSTRAINT fk_customers_credit_history_customer_id FOREIGN KEY (customer_id) REFERENCES customers(customer_id));

CREATE TABLE payments(
	payement_id INT(11) PRIMARY KEY AUTO_INCREMENT,
	date DATE,
	amount DECIMAL(10,2),
	loan_id INT(11),
	CONSTRAINT fk_loan_id FOREIGN KEY (loan_id) REFERENCES loans(loan_id));
...
CREATE TABLE users(
	...
	CONSTRAINT fk_customer_id_users_customers FOREIGN KEY (customer_id) REFERENCES customers(customer_id));
	
ALTER TABLE employees
ADD column manager_id INT,
ADD CONSTRAINT fk_manager_id_employees FOREIGN KEY (manager_id) REFERENCES employees(employee_id);
...
SELECT (IF(DATE(c.date_of_birth)>'1980-01-01',1000,1500 )+IF(c.gender='M',100,200)),
 '2015-12-10',NULL, IF(c.customer_id>15,3,IF(c.customer_id MOD 2=0,2,1)),c.customer_id  FROM customers AS c
