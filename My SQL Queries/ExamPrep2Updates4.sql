...
CREATE TABLE users(
	...
	CONSTRAINT fk_locations_location_id FOREIGN KEY (location_id) REFERENCES locations(id),
	CONSTRAINT fk_credentials_credential_id FOREIGN KEY (credential_id) REFERENCES credentials(id));
...
CREATE TABLE messages(
	...
	chat_id INT,
	user_id INT,
	CONSTRAINT fk_chats_chat_id FOREIGN KEY (chat_id) REFERENCES chats(id),
	CONSTRAINT fk_users_user_id FOREIGN KEY (user_id) REFERENCES users(id));
	
CREATE TABLE users_chats(
	user_id INT,
	chat_id INT,
	CONSTRAINT pk PRIMARY KEY(user_id,chat_id),
	CONSTRAINT fk_user_id_users FOREIGN KEY (user_id) REFERENCES users(id),
	CONSTRAINT fk_chat_id_chats FOREIGN KEY (chat_id) REFERENCES chats(id));
